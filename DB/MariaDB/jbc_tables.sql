CREATE TABLE `jbcdb`.`jbc_page_type` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `jbc_page_type` VARCHAR(150) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `jbc_page_type_UNIQUE` (`jbc_page_type` ASC));
...
CREATE TABLE `jbc_log_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `log_form_name` varchar(150) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `jbc_log_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `log_table_name` varchar(150) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `jbc_log` (
  ...
  CONSTRAINT `jbc_log_ibfk_3` FOREIGN KEY (`type_name`) REFERENCES `jbc_log_table` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `jbc_log_ibfk_4` FOREIGN KEY (`table_name`) REFERENCES `jbc_log_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
);
