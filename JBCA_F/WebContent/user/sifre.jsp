				...
				<table class="table table-borderless">
					<tbody>
						<tr>
							...
							<td><input type="<%=p.inputTypes[1]%>" class="form-control form-control-sm" name="<%=p.fieldNames[1]%>" id="g_1"
								placeholder="<%=p.labelNames[1]%> giriniz." required></td>
							<td><label for="g_2" style="margin-top: 7px;"><%=p.labelNames[2]%>:</label></td>
							<td><input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm" name="<%=p.fieldNames[2]%>" id="g_2"
								placeholder="<%=p.labelNames[2]%> giriniz." required></td>
							<td><label for="g_3" style="margin-top: 7px;"><%=p.labelNames[3]%>:</label></td>
							<td><input type="<%=p.inputTypes[3]%>" class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="g_3"
						...
						<tr>
							<td><button type="submit" class="btn btn-outline-info btn-sm"
									onclick='sendUpdate("/<%=p.contextRoot%>/<%=servletName%>", "guncelleK")'>Kaydet</button></td>
