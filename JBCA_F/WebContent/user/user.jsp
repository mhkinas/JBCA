...
<%@ page session="false"%>
<%@ page import="com.jbca.user.UserParams,com.jbca.base.BaseProcesses, 
...
<%
	...
	String jsObjData = null, servletName = "userServlet", selectLists = null,
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="<%=p.inputTypes[4]%>"
										...
										placeholder="Enter <%=p.labelNames[4]%>" list="groups"
										required></td>
									...
									<td><input type="<%=p.inputTypes[5]%>"
										...
										placeholder="Enter <%=p.labelNames[5]%>" required></td>
									<td>&nbsp;</td>
									<td><label for="y_6"><%=p.labelNames[6]%>:</label></td>
									<td><input type="<%=p.inputTypes[6]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[6]%>" id="y_6"
										placeholder="Enter <%=p.labelNames[6]%>" list="statuses"></td>
									<datalist id="statuses"></datalist>
								</tr>
								<tr>
									<td><label for="y_7"><%=p.labelNames[7]%>:</label></td>
									<td><input type="<%=p.inputTypes[7]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[7]%>" id="y_7"
										placeholder="Enter <%=p.labelNames[7]%>" min="10" max="100"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[2]%>"
										...
										placeholder="Enter <%=p.selectLabels[2]%>" list="groups"></td>
									...
									<td><input type="<%=p.selectITs[3]%>"
										...
										placeholder="Enter <%=p.selectLabels[3]%>"></td>
								</tr>
								<tr>
