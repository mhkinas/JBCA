...
<%@ page session="false"%>
<%@ page import="com.jbca.user.MessageMapParams,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>
<%
	MessageMapParams p = new MessageMapParams();
	p.setLangLoc();
	...
	String jsObjData = null, servletName = "messageMapServlet", selectLists = null,
	...
	try {
		...
		else if(p.sessionBean.getGroup().equals("Normal"))
		{
			...
			leftSideStr = p.pageBean.getPage(null, false, new String[] {"Normal-Sidebar-TR","/JBCA_F/code/"});
		}
...
<body>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[1]%>"
										...
										placeholder="<%=p.labelNames[1]%> giriniz." list="messages"
										required></td>
									<datalist id="messages"></datalist>
									<td>&nbsp;</td>
									<td><label for="y_2"><%=p.labelNames[2]%>:</label></td>
									<td><input type="<%=p.inputTypes[2]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[2]%>" id="y_2"
										placeholder="<%=p.labelNames[2]%> giriniz." list="groups"
										required></td>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[1]%>"
										...
										placeholder="<%=p.selectLabels[1]%> giriniz." list="messages"></td>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_1", name:"mapped_msg"}, {id:"y_2", name:"user_group"}], 
							araK:[{id:"s_2", name:"mapped_msg"}, {id:"s_3", name:"user_group"}, {id:"s_4", name:"rec_user"}], 
							guncelleK:[{id:"g_2", name:"mapped_msg"}, {id:"g_3", name:"user_group"}]};
		
		listN4Page = [{id:"messages", name:"mapped_msg"}, {id:"groups", name:"user_group"}, {id:"users", name:"rec_user"}];

		listN4Modal = [{id:"messages", name:"mapped_msg"}, {id:"groups", name:"user_group"}];
