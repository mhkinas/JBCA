...
<body>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[1]%>"
										...
										placeholder="Enter <%=p.labelNames[1]%>" list="messages"
										required></td>
									...
									<td><input type="<%=p.inputTypes[2]%>"
										...
										placeholder="Enter <%=p.labelNames[2]%>" list="groups"
										required></td>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[1]%>"
										...
										placeholder="Enter <%=p.selectLabels[1]%>" list="messages"></td>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_1", name:"mapped_msg"}, {id:"y_2", name:"user_group"}], 
							searchR:[{id:"s_2", name:"mapped_msg"}, {id:"s_3", name:"user_group"}, {id:"s_4", name:"rec_user"}], 
							updateR:[{id:"g_2", name:"mapped_msg"}, {id:"g_3", name:"user_group"}]};
