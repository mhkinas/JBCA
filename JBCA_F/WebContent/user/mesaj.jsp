...
<body>
  ...
  <script>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_2", name:"message_type"},{id:"y_3", name:"rec_status"}], araK:[{id:"s_3", name:"message_type"}, 
					{id:"s_4", name:"rec_user"}], guncelleK:[{id:"g_3", name:"message_type"}, {id:"g_4", name:"rec_status"}]};
