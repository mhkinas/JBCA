...
<%@ page session="false"%>
<%@ page import="com.jbca.user.MessageParams,com.jbca.base.BaseProcesses, 
...
<%
	...
	String jsObjData = null, servletName = "messageServlet", selectLists = null, errorString = null, qsql = null, 
					...
					<tbody>
						<tr>
							...
							<td><input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm" name="<%=p.fieldNames[2]%>" id="y_2"
								placeholder="Enter <%=p.labelNames[2]%>" list="types" required></td>
							...
							<td><input type="<%=p.inputTypes[3]%>" class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="y_3"
								placeholder="Enter <%=p.labelNames[3]%>" list="statuses" required></td>
						...
						<tr>
							...
							<td colspan="7"><textarea class="form-control form-control-sm" name="<%=p.fieldNames[4]%>" id="y_4"
								placeholder="Enter <%=p.labelNames[4]%>" required rows="20" cols="100"></textarea></td>
						</tr>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td><input type="<%=p.selectITs[2]%>" class="form-control form-control-sm" id="s_3" name="<%=p.selectFields[2]%>" 
									   placeholder="Enter <%=p.selectLabels[2]%>" list="types"></td>
,							<td>&nbsp;</td><td>&nbsp;</td>
						</tr>
						<tr>
  ...
  <script>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_2", name:"message_type"},{id:"y_3", name:"rec_status"}], searchR:[{id:"s_3", name:"message_type"}, 
					{id:"s_4", name:"rec_user"}], updateR:[{id:"g_3", name:"message_type"}, {id:"g_4", name:"rec_status"}]};
		
		listN4Page = [{id:"types", name:"message_type"}, {id:"statuses", name:"rec_status"}, {id:"codes", name:"rec_user"}];
		listN4Modal = [{id:"types", name:"message_type"}, {id:"statuses", name:"rec_status"}];
