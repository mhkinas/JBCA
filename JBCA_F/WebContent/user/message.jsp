				...
				<div class="form-group">
					<div class="row"> 
						...
						<div class="col-md-auto col-4">
							...
							<input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm" name="<%=p.fieldNames[2]%>" id="y_2"
								placeholder="<%=p.labelNames[2]%> giriniz." list="types" required>
						...
						<div class="col-md-auto col-4">
							...
							<input type="<%=p.inputTypes[3]%>" class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="y_3"
								placeholder="<%=p.labelNames[3]%> giriniz." list="statuses" required>
					...
					<div class="row">
						<div class="col-md-4">
							...
							<textarea class="form-control form-control-sm" name="<%=p.fieldNames[4]%>" id="y_4"
									placeholder="<%=p.labelNames[4]%> giriniz." required rows="20" cols="100"></textarea>
						</div>
					</div>
					<div class="row">&nbsp;</div>
					<div class="row">
