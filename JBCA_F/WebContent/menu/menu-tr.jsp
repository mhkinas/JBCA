...
<body>
	...
	<div class="container-fluid">
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="col-md-auto col-8">
								...
								<textarea class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="y_3"
											placeholder="<%=p.labelNames[3]%> giriniz." required rows="20" cols="100"></textarea>
							</div>
						</div>
						<div class="row">&nbsp;</div>
						<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#guncelleK" class="btn btn-outline-dark" data-bs-toggle="collapse"><%=p.jspTitle%> Güncelle</a>
				<form method="post" id="guncelleK" class="form collapse" enctype="multipart/form-data">
					<div class="form-group">
						<div class="row"> 
							<div class="col-md-auto col-4">
								<label for="g_1"><%=p.labelNames[0]%>:</label>
								<input type="<%=p.inputTypes[0]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[0]%>" id="g_1" placeholder="<%=p.labelNames[0]%> giriniz." required readonly>
							</div>
							<div class="col-md-auto col-4">
								<label for="g_2"><%=p.labelNames[1]%>:</label>
								<input type="<%=p.inputTypes[1]%>" class="form-control form-control-sm"
									name="<%=p.fieldNames[1]%>" id="g_2" placeholder="<%=p.labelNames[1]%> giriniz." required>
							</div>
							<div class="col-md-auto col-4">
								<label for="g_3"><%=p.labelNames[2]%>:</label>
								<input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm"
						...
						<div class="row">
							<div class="col-md-auto col-8">
								<label for="g_4"><%=p.labelNames[3]%>:</label>
								<textarea class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="g_4"
											placeholder="<%=p.labelNames[3]%> giriniz." required rows="20" cols="100"></textarea>
							</div>
						</div>
						<div class="row">&nbsp;</div>
						<div class="row">
							<div class="col-md-auto col-4">
								<label for="g_5"><%=p.labelNames[4]%>:</label>
								<input type="<%=p.inputTypes[4]%>" class="form-control form-control-sm"
									name="<%=p.fieldNames[4]%>" id="g_5" placeholder="<%=p.labelNames[4]%> giriniz." required readonly>
							</div>
							<div class="col-md-auto col-4">
								<label for="g_6"><%=p.labelNames[5]%>:</label>
								<input type="<%=p.inputTypes[5]%>" class="form-control form-control-sm"
									name="<%=p.fieldNames[5]%>" id="g_6" placeholder="<%=p.labelNames[5]%> giriniz." required readonly>
							</div>
						</div>
						<div class="row">&nbsp;</div>
						<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#araK" class="btn btn-outline-dark" data-bs-toggle="collapse"><%=p.jspTitle%>
					Ara</a>
						...
						<div class="row"> 
							...
							<div class="col-md-auto col-3">
								...
								<input type="<%=p.selectITs[3]%>" class="form-control form-control-sm" id="s_4" name="<%=p.selectFields[3]%>"
										   placeholder="<%=p.selectLabels[3]%> giriniz." list="types">
