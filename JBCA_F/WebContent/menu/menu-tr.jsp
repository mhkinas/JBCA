...
<%@ page session="false"%>
<%@ page
	import="com.jbca.menu.MenuParams,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>
<%
	MenuParams p = new MenuParams();
	p.setLangLoc();
	...
	String jsObjData = null, servletName = "menuServlet", jspTitle = "Menü", selectLists = null,
...
<body>
	...
	<div class="container-fluid">
						...
						<table class="table table-borderless">
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[1]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[1]%>" id="y_1" placeholder="<%=p.labelNames[1]%> giriniz." required></td>
									<td>&nbsp;</td>
									<td><label for="y_2"><%=p.labelNames[2]%>:</label></td>
									<td><input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[2]%>" id="y_2" placeholder="<%=p.labelNames[2]%> giriniz." list="paths"
										required></td>
								...
								<tr>
									...
									<td colspan="10"><textarea class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="y_3"
											placeholder="<%=p.labelNames[3]%> giriniz." required rows="20" cols="100"></textarea></td>
								</tr>
								<tr>
									...
									<td><button type="reset"
											class="btn btn-outline-secondary btn-sm">İptal</button></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#guncelleK" class="btn btn-outline-dark" data-toggle="collapse"><%=p.jspTitle%> Güncelle</a>
				<form method="post" id="guncelleK" class="form collapse" enctype="multipart/form-data">
					<div class="form-group">
						<table class="table table-borderless">
							<tbody>
								<tr>
									<td><label for="g_1"><%=p.labelNames[0]%>:</label></td>
									<td><input type="<%=p.inputTypes[0]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[0]%>" id="g_1" placeholder="<%=p.labelNames[0]%> giriniz." required readonly></td>
									<td>&nbsp;</td>
									<td><label for="g_2"><%=p.labelNames[1]%>:</label></td>
									<td><input type="<%=p.inputTypes[1]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[1]%>" id="g_2" placeholder="<%=p.labelNames[1]%> giriniz." required></td>
									<td>&nbsp;</td>
									<td><label for="g_3"><%=p.labelNames[2]%>:</label></td>
									<td><input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[2]%>" id="g_3" placeholder="<%=p.labelNames[2]%> giriniz." required
										list="paths"></td>
								</tr>
								<tr>
									<td><label for="g_4"><%=p.labelNames[3]%>:</label></td>
									<td colspan="10"><textarea class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="g_4"
											placeholder="<%=p.labelNames[3]%> giriniz." required rows="20" cols="100"></textarea></td>
								</tr>
								<tr>
									<td><label for="g_5"><%=p.labelNames[4]%>:</label></td>
									<td><input type="<%=p.inputTypes[4]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[4]%>" id="g_5" placeholder="<%=p.labelNames[4]%> giriniz." required readonly></td>
									<td>&nbsp;</td>
									<td><label for="g_6"><%=p.labelNames[5]%>:</label></td>
									<td><input type="<%=p.inputTypes[5]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[5]%>" id="g_6" placeholder="<%=p.labelNames[5]%> giriniz." required readonly></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#araK" class="btn btn-outline-dark" data-toggle="collapse"><%=p.jspTitle%>
					Ara</a>
				<form method="post" id="araK" class="form collapse" enctype="multipart/form-data">
					<div class="form-group">
						<table class="table table-borderless">
							<tbody>
								<tr>
									<td><label for="s_1" class="col-form-label-sm"
										class="col-form-label-sm"><%=p.selectLabels[0]%>:</label></td>
									<td><input type="<%=p.selectITs[0]%>"
										class="form-control form-control-sm" id="s_1"
										name="<%=p.selectFields[0]%>"
										placeholder="<%=p.selectLabels[0]%> giriniz."></td>
									<td><label for="s_2" class="col-form-label-sm"><%=p.selectLabels[1]%>:</label></td>
									<td><input type="<%=p.selectITs[1]%>"
										class="form-control form-control-sm" id="s_2"
										name="<%=p.selectFields[1]%>"
										placeholder="<%=p.selectLabels[1]%> giriniz."></td>
									<td><label for="s_3" class="col-form-label-sm"><%=p.selectLabels[2]%>:</label></td>
									<td><input type="<%=p.selectITs[2]%>"
										class="form-control form-control-sm" id="s_3"
										name="<%=p.selectFields[2]%>"
										placeholder="<%=p.selectLabels[2]%> giriniz." list="paths"></td>
									<td><label for="s_4" class="col-form-label-sm"><%=p.selectLabels[3]%>:</label></td>
									<td><input type="<%=p.selectITs[3]%>"
										class="form-control form-control-sm" id="s_4"
										name="<%=p.selectFields[3]%>"
										placeholder="<%=p.selectLabels[3]%> giriniz." list="codes"></td>
									<datalist id="codes"></datalist>
								</tr>
								<tr>
									<td><label for="s_5" class="col-form-label-sm"><%=p.selectLabels[4]%>:</label></td>
									<td><input type="<%=p.selectITs[4]%>"
										class="form-control form-control-sm" id="s_5"
										name="<%=p.selectFields[4]%>"
										placeholder="<%=p.selectLabels[4]%> giriniz."></td>
									<td><label for="s_6" class="col-form-label-sm"><%=p.selectLabels[5]%>:</label></td>
									<td><input type="<%=p.selectITs[5]%>"
										class="form-control form-control-sm" id="s_6"
										name="<%=p.selectFields[5]%>"
					...
					<table
						...
						<thead>
							...
							<tr>
								...
								<th onclick="sortByProp('<%=p.fieldNames[3]%>')"
									style="display: none;"><%=p.labelNames[3]%></th>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_2", name:"adr_path"}], araK:[{id:"s_3", name:"adr_path"},
					 	{id:"s_4", name:"rec_user"}], guncelleK:[{id:"g_3", name:"adr_path"}]};
		
		listN4Page = [{id:"paths", name:"adr_path"}, {id:"codes", name:"rec_user"}];
