...
<%
	...
	String jsObjData = null, servletName = "menuServlet", selectLists = null, errorString = null, 
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-11 col-xl-10">
				<a href="#newR" class="btn btn-outline-dark" data-toggle="collapse">New
					<%=p.jspTitle%></a>
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="10"><textarea
											...
											placeholder="Enter <%=p.labelNames[3]%>" required rows="20"
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#updateR" class="btn btn-outline-dark"
					data-toggle="collapse">Update <%=p.jspTitle%></a>
				<form method="post" id="updateR" class="form collapse"
						...
						<table class="table table-borderless">
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[0]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[0]%>" id="g_1"
										placeholder="Enter <%=p.labelNames[0]%>" required readonly></td>
									<td>&nbsp;</td>
									<td><label for="g_2"><%=p.labelNames[1]%>:</label></td>
									<td><input type="<%=p.inputTypes[1]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[1]%>" id="g_2"
										placeholder="Enter <%=p.labelNames[1]%>" required></td>
									<td>&nbsp;</td>
									<td><label for="g_3"><%=p.labelNames[2]%>:</label></td>
									<td><input type="<%=p.inputTypes[2]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[2]%>" id="g_3"
										placeholder="Enter <%=p.labelNames[2]%>" required list="paths"></td>
								</tr>
								<tr>
									<td><label for="g_4"><%=p.labelNames[3]%>:</label></td>
									<td colspan="10"><textarea
											class="form-control form-control-sm"
											name="<%=p.fieldNames[3]%>" id="g_4"
											placeholder="Enter <%=p.labelNames[3]%>" required rows="20"
											cols="100"></textarea></td>
								</tr>
								<tr>
									<td><label for="g_5"><%=p.labelNames[4]%>:</label></td>
									<td><input type="<%=p.inputTypes[4]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[4]%>" id="g_5"
										placeholder="Enter <%=p.labelNames[4]%>" required readonly></td>
									<td>&nbsp;</td>
									<td><label for="g_6"><%=p.labelNames[5]%>:</label></td>
									<td><input type="<%=p.inputTypes[5]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[5]%>" id="g_6"
										placeholder="Enter <%=p.labelNames[5]%>" required readonly></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_2", name:"adr_path"}], searchR:[{id:"s_3", name:"adr_path"},
					 	{id:"s_4", name:"rec_user"}], updateR:[{id:"g_3", name:"adr_path"}]};
