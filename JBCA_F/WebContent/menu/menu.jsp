...
<body>
	...
	<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-auto col-8">
								...
								<textarea class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="y_3"
											placeholder="Enter <%=p.labelNames[3]%>." required rows="20" cols="100"></textarea>
							</div>
						</div>
						<div class="row">&nbsp;</div>
						<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#updateR" class="btn btn-outline-dark" data-bs-toggle="collapse"><%=p.jspTitle%> Update</a>
				<form method="post" id="updateR" class="form collapse" enctype="multipart/form-data">
					<div class="form-group">
						<div class="row"> 
							<div class="col-md-auto col-4">
								<label for="g_1"><%=p.labelNames[0]%>:</label>
								<input type="<%=p.inputTypes[0]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[0]%>" id="g_1" placeholder="Enter <%=p.labelNames[0]%>." required readonly>
							</div>
							<div class="col-md-auto col-4">
								<label for="g_2"><%=p.labelNames[1]%>:</label>
								<input type="<%=p.inputTypes[1]%>" class="form-control form-control-sm"
									name="<%=p.fieldNames[1]%>" id="g_2" placeholder="Enter <%=p.labelNames[1]%>." required>
							</div>
							<div class="col-md-auto col-4">
								<label for="g_3"><%=p.labelNames[2]%>:</label>
								<input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm"
									name="<%=p.fieldNames[2]%>" id="g_3" placeholder="Enter <%=p.labelNames[2]%>." required
									list="paths">
							</div>
						</div>
						<div class="row">&nbsp;</div>
						...
						<div class="row">
							<div class="col-md-auto col-4">
								...
								<input type="<%=p.inputTypes[4]%>" class="form-control form-control-sm"
									name="<%=p.fieldNames[4]%>" id="g_5" placeholder="Enter <%=p.labelNames[4]%>." required readonly>
							</div>
							<div class="col-md-auto col-4">
								<label for="g_6"><%=p.labelNames[5]%>:</label>
								<input type="<%=p.inputTypes[5]%>" class="form-control form-control-sm"
									name="<%=p.fieldNames[5]%>" id="g_6" placeholder="Enter <%=p.labelNames[5]%>." required readonly>
							</div>
						</div>
						<div class="row">&nbsp;</div>
						<div class="row">
							<div class="col-md-auto col-2">
								<button type="submit" class="btn btn-outline-info btn-sm"
										onclick='sendUpdate("/<%=p.contextRoot%>/<%=servletName%>", "newR")'>Save</button>
							</div>
							<div class="col-md-auto col-2">
						...
						<div class="row">
							<div class="col-md-auto col-3">
								...
								<input type="<%=p.selectITs[4]%>" class="form-control form-control-sm" id="s_5" name="<%=p.selectFields[4]%>"
									placeholder="Enter <%=p.selectLabels[4]%>.">
							</div>
							<div class="col-md-auto col-3">
