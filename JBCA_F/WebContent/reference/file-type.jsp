...
<%@ page session="false"%>
<%@ page import="com.jbca.file.FileTypeParams,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>

<%
	FileTypeParams p = new FileTypeParams();
	p.setLangEN();
	
	BaseProcesses process = new BaseProcesses(request, response, p);
	process.checkSes4JSP();

	String jsObjData = null, servletName = "fileTypeServlet", errorString = null,
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#araK" class="btn btn-outline-dark" data-toggle="collapse">Search
					<%=p.jspTitle%></a>
