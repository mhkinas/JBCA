...
<%
	...
	String jsObjData = null, servletName = "messageTypeServlet", errorString = null,
	...
	try {
		...
		leftSideStr = p.pageBean.getPage(null, false, new String[] {"Referans-Sidebar","/JBCA_F/page/"});
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[0]%>"
										...
										placeholder="<%=p.labelNames[0]%> giriniz."></td>
									...
									<td><input type="<%=p.inputTypes[1]%>"
										...
										placeholder="<%=p.labelNames[1]%> giriniz."></td>
									<td>&nbsp;&nbsp;&nbsp;</td>
								</tr>
								<tr></tr>
								<tr>
