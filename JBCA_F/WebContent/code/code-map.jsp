...
<%@ page session="false"%>
<%@ page
	import="com.jbca.code.CodeMapParams,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>
<%
	CodeMapParams p = new CodeMapParams();
	p.setLangEN();
	...
	String jsObjData = null, servletName = "codeMapServlet", selectLists = null,
...
<body>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[1]%>"
										...
										placeholder="Enter <%=p.labelNames[1]%>" list="codes" required></td>
									...
									<td><input type="<%=p.inputTypes[2]%>"
										...
										placeholder="Enter <%=p.labelNames[2]%>" list="pages" required></td>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[1]%>"
										...
										placeholder="Enter <%=p.selectLabels[1]%>" list="codes"></td>
									...
									<td><input type="<%=p.selectITs[2]%>"
										...
										placeholder="Enter <%=p.selectLabels[2]%>" list="pages"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="<%=p.selectITs[3]%>"
										...
										placeholder="Enter <%=p.selectLabels[3]%>" list="users"></td>
					...
					<table
						...
						<thead>
							...
							<tr>
								...
								<th onclick="sortByDate('<%=p.fieldNames[4]%>', true)"><%=p.labelNames[4]%></th>
							</tr>
						</thead>
						<tbody id="listTb">
						</tbody>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_1", name:"mapped_code"}, {id:"y_2", name:"page_link"}], 
					 searchR:[{id:"s_2", name:"mapped_code"}, {id:"s_3", name:"page_link"}, {id:"s_4", name:"rec_user"}], 
					 updateR:[{id:"g_2", name:"mapped_code"}, {id:"g_3", name:"page_link"}]};
		
		listN4Page = [{id:"codes", name:"mapped_code"}, {id:"pages", name:"page_link"}, {id:"users", name:"rec_user"}];

		listN4Modal = [{id:"codes", name:"mapped_code"}, {id:"pages", name:"page_link"}];
									...
									<tr>
										<td colspan="2">
											<button type="submit" class="btn btn-outline-info btn-sm"
												onclick='sendUpdate("/<%=p.contextRoot%>/<%=servletName%>","updateR")'>Kaydet</button>
											&nbsp;
											<button type="button" class="btn btn-outline-danger btn-sm"
												onclick='sendDelete("/<%=p.contextRoot%>/<%=servletName%>","updateR")'>Sil</button>
											&nbsp;
