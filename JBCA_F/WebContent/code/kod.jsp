...
<%
	...
	String jsObjData = null, servletName = "codeServlet", selectLists = null, errorString = null, qsql = null, 
			menuString = null, leftSideStr = null, excelCols = null;
...
<body>
					...
					<tbody>
						<tr>
							...
							<td><input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm" name="<%=p.fieldNames[2]%>" id="y_2"
								placeholder="<%=p.labelNames[2]%> giriniz." list="paths" required></td>
							...
							<td><input type="<%=p.inputTypes[3]%>" class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="y_3"
								placeholder="<%=p.labelNames[3]%> giriniz." list="types" required></td>
								<datalist id="types"></datalist>
						</tr>
						<tr>
							<td><label for="y_4">Dosya :</label></td>
							<td><input type="file" class="form-control-file border form-control-sm" name="<%=p.fileField%>" id="y_4"
								required onchange="fileNameInfo('y_4', 'y_1')"></td>
							<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
						</tr>
						<tr>
  ...
  <script>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_2", name:"adr_path"},{id:"y_3", name:"code_type"}], araK:[{id:"s_3", 
						name:"adr_path"}, {id:"s_4", name:"code_type"}, {id:"s_5", name:"rec_user"}], guncelleK:[{id:"g_3", name:"adr_path"}, 
			  ...
			  <div class="form-group">
				...
				<div class="modal-footer">
					<table class="table table-borderless">
						<tbody id="modBt">
							<tr>
							  <td><label for="g_8">Kod :</label></td>
							  <td><input type="file" class="form-control-file border form-control-sm" name="<%=p.fileField%>" id="g_8">
							  </td>
							</tr>
							<tr>
							  <td colspan="2">
