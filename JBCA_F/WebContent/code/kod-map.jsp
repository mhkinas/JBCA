...
<%
	...
	String jsObjData = null, servletName = "codeMapServlet", selectLists = null, errorString = null, 
	...
	try {
		...
		//p.strAry = new String[] {"Normal-Kul-Menu","/JBCA_F/menu/", "/JBCA_F/menu/"};
		...
		leftSideStr = p.pageBean.getPage(null, false, new String[] {"Kodlar-Sidebar","/JBCA_F/page/"});
...
<body>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[1]%>"
										...
										placeholder="<%=p.labelNames[1]%> giriniz." list="codes"
										required></td>
									...
									<td><input type="<%=p.inputTypes[2]%>"
										...
										placeholder="<%=p.labelNames[2]%> giriniz." list="pages"
										required></td>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[1]%>"
										...
										placeholder="<%=p.selectLabels[1]%> giriniz." list="codes"></td>
									...
									<td><input type="<%=p.selectITs[2]%>"
										...
										placeholder="<%=p.selectLabels[2]%> giriniz." list="pages"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
								<tr>
									...
									<td><input type="<%=p.selectITs[3]%>"
										...
										placeholder="<%=p.selectLabels[3]%> giriniz." list="users"></td>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_1", name:"mapped_code"}, {id:"y_2", name:"page_link"}], 
							araK:[{id:"s_2", name:"mapped_code"}, {id:"s_3", name:"page_link"}, {id:"s_4", name:"rec_user"}], 
							guncelleK:[{id:"g_2", name:"mapped_code"}, {id:"g_3", name:"page_link"}]};
