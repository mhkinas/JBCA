	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-11 col-md-10">
				<a href="#yeniK" class="btn btn-outline-dark" data-bs-toggle="collapse">Yeni
					<%=p.jspTitle%></a>
						...
						<div class="row"> 
							<div class="col-md-auto col-4">
								...
								<input type="<%=p.inputTypes[1]%>" class="form-control form-control-sm" name="<%=p.fieldNames[1]%>" id="y_1"
										placeholder="<%=p.labelNames[1]%> giriniz." list="codes" required>
							...
							<div class="col-md-auto col-4">
								...
								<input type="<%=p.inputTypes[2]%>"class="form-control form-control-sm"name="<%=p.fieldNames[2]%>" id="y_2"
										placeholder="<%=p.labelNames[2]%> giriniz." list="pages" required>
									<dataRegister id="pages"></dataRegister>
							</div>
						</div>
						<div class="row">&nbsp;</div>
						<div class="row">
							<div class="col-md-auto col-2">
								<button type="submit" class="btn btn-outline-info btn-sm" onclick='sendInsert("/<%=p.contextRoot%>/<%=servletName%>", "yeniK")'>Kaydet</button>
							</div>
							<div class="col-md-auto col-2">
						...
						<div class="row"> 
							...
							<div class="col-md-auto col-4">
								...
								<input type="<%=p.selectITs[1]%>" class="form-control form-control-sm" id="s_2" name="<%=p.selectFields[1]%>"
										placeholder="<%=p.selectLabels[1]%> giriniz." list="codes">
							</div>
							<div class="col-md-auto col-4">
								...
								<input type="<%=p.selectITs[2]%>" class="form-control form-control-sm" id="s_3" name="<%=p.selectFields[2]%>"
										placeholder="<%=p.selectLabels[2]%> giriniz." list="pages">
							</div>
						<div class="row"> 
							<div class="col-md-auto col-4">
								...
								<input type="<%=p.selectITs[3]%>" class="form-control form-control-sm" id="s_4" name="<%=p.selectFields[3]%>"
									placeholder="<%=p.selectLabels[3]%> giriniz." list="users">
								<dataRegister id="users"></dataRegister>
							</div>
							<div class="col-md-auto col-4">
