...
<%@ page session="false"%>
<%@ page import="com.jbca.code.CodeParams,com.jbca.base.BaseProcesses, 
...
<%
	...
	String jsObjData = null, servletName = "codeServlet", selectLists = null, errorString = null, 
	...
	try {
		...
		leftSideStr = p.pageBean.getPage(null, false, new String[] {"Codes-Sidebar","/JBCA_F/page/"});
...
<body>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[1]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[1]%>" id="y_1" placeholder="Enter <%=p.labelNames[1]%>" required></td>
									<td>&nbsp;</td>
									<td><label for="y_2"><%=p.labelNames[2]%>:</label></td>
									<td><input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[2]%>" id="y_2" placeholder="Enter <%=p.labelNames[2]%>" list="paths" 
										required></td>
									<datalist id="paths"></datalist>
									<td>&nbsp;</td>
									<td><label for="y_3"><%=p.labelNames[3]%>:</label></td>
									<td><input type="<%=p.inputTypes[3]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[3]%>" id="y_3" placeholder="Enter <%=p.labelNames[3]%>" list="types" 
										required></td>
								...
								<tr>
									...
									<td><input type="file" class="form-control-file border form-control-sm"
										name="<%=p.fileField%>" id="y_4" required 
										onchange="fileNameInfo('y_4', 'y_1')"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_2", name:"adr_path"},{id:"y_3", name:"code_type"}], searchR:[{id:"s_3", 
						name:"adr_path"}, {id:"s_4", name:"code_type"}, {id:"s_5", name:"rec_user"}], updateR:[{id:"g_3", name:"adr_path"}, 
						{id:"g_4", name:"code_type"}]};
					...
					<div class="form-group">
						...
						<div class="modal-footer">
							<table class="table table-borderless">
								<tbody id="modBt">
									<tr>
										<td><label for="g_8">Code :</label></td>
										<td><input type="file"
