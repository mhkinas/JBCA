...
<body>
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="<%=p.inputTypes[4]%>"
										...
										placeholder="<%=p.labelNames[4]%> giriniz." required></td>
									<td>&nbsp;</td>
									<td><label for="y_5">Dosya :</label></td>
									<td><input type="file"
										class="form-control-file border form-control-sm"
										name="<%=p.fileField%>" id="y_5" required
										onchange="fileInfo('y_5', 'y_1', 'y_4', 'y_6')"></td>
									<td>&nbsp;</td>
									<td><label for="y_6"><%=p.labelNames[5]%>:</label></td>
									<td><input type="<%=p.inputTypes[5]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[5]%>" id="y_6"
										placeholder="<%=p.labelNames[5]%> giriniz." ></td>
								</tr>
								<tr>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_2", name:"adr_path"},{id:"y_3", name:"file_type"}], araK:[{id:"s_3", name:"adr_path"}, 
						{id:"s_4", name:"file_type"}, {id:"s_5", name:"rec_user"}], guncelleK:[{id:"g_3", name:"adr_path"}, 
					...
					<div class="form-group">
						...
						<div class="modal-footer">
							<table class="table table-borderless">
								<tbody id="modBt">
									<tr>
										<td><label for="g_9">Dosya :</label></td>
										<td><input type="file"
											class="form-control-file border form-control-sm"
									...
									<tr>
										<td colspan="2">
											...
											<button type="button" class="btn btn-outline-info btn-sm"
												onclick='sendDownload("/<%=p.contextRoot%>/<%=servletName%>","guncelleK","g_2",false)'>Dosya
												İndir</button> &nbsp;
