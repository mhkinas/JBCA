...
<%@ page session="false"%>
<%@ page import="com.jbca.log.LogTableParams,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>

<%
	LogTableParams p = new LogTableParams();
	p.setLangLoc();
	
	BaseProcesses process = new BaseProcesses(request, response, p);
	process.checkSes4JSP();

	String jsObjData = null, servletName = "logTableServlet", errorString = null,
	...
	try {
		...
		leftSideStr = p.pageBean.getPage(null, false, new String[] {"Loglar-Sidebar","/JBCA_F/page/"});
