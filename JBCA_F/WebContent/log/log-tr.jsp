...
<%
	...
	String jsObjData = null, servletName = "logServlet", selectLists = null, errorString = null, qsql = null, 
			menuString = null, codeStrMW90 = null, leftSideStr = null, excelCols = null;
...
<body>
					...
					<tbody>
						<tr>
							...
							<td><input type="<%=p.selectITs[1]%>" class="form-control form-control-sm" id="s_2" name="<%=p.selectFields[1]%>"
									   placeholder="<%=p.selectLabels[1]%> giriniz." list="forms"></td>
							...
							<td><input type="<%=p.selectITs[2]%>" class="form-control form-control-sm" id="s_3" name="<%=p.selectFields[2]%>" 
									   placeholder="<%=p.selectLabels[2]%> giriniz." list="types"></td>
							...
							<td><input type="<%=p.selectITs[3]%>" class="form-control form-control-sm" id="s_4" name="<%=p.selectFields[3]%>"
									   placeholder="<%=p.selectLabels[3]%> giriniz." list="tables"></td>
  ...
  <script>
	...
	<%}%>		
		...
		selInpIds = {araK:[{id:"s_2", name:"form_name"}, {id:"s_3", name:"type_name"}, {id:"s_4", name:"jbc_table_name"}, 
						   {id:"s_5", name:"rec_user"}]};
		
		listN4Page = [{id:"forms", name:"form_name"}, {id:"types", name:"type_name"}, {id:"tables", name:"jbc_table_name"}, 
					  {id:"codes", name:"rec_user"}];
		listN4Modal = [{id:"forms", name:"form_name"}, {id:"types", name:"type_name"}, {id:"tables", name:"jbc_table_name"}];
	  ...
	  <div class="modal-dialog modal-custom">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title"><%=p.jspTitle%> İncele</h4>
