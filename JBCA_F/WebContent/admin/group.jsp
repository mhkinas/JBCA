...
<%@ page session="false"%>
<%@ page import="com.jbca.admin.GroupParams,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>

<%
	GroupParams p = new GroupParams();
	p.setLangEN();

	BaseProcesses process = new BaseProcesses(request, response, p);
	process.checkSes4JSP();

	String jsObjData = null, servletName = "groupServlet", jspTitle = "Group", errorString = null, qsql = null, menuString = null, 
		...
		<div class="modal-dialog modal-lg">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title"><%=p.jspTitle%> Update</h4>
