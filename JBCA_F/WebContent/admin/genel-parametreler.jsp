...
<%@ page session="false"%>
<%@ page import="com.jbca.admin.GeneralParameters,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>

<%
	GeneralParameters p = new GeneralParameters();
	p.setLangLoc();
	
	BaseProcesses process = new BaseProcesses(request, response, p);
	process.checkSes4JSP();

	String jsObjData = null, servletName = "genelParamServlet", errorString = null,
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
		  ...
		  <div class="col-sm-11 col-md-10">
			<a href="#yeniK" class="btn btn-outline-secondary" data-bs-toggle="collapse">Yeni <%=p.jspTitle%></a>
			<form method="post" id="yeniK" class="form collapse" enctype="multipart/form-data">
				<div class="form-group">
					<div class="row"> 
						...
						<div class="col-md-auto col-4">
							<label for="y_2" style="margin-top: 7px;"><%=p.labelNames[2]%>:</label>
		...
		<div class="row"> 
		  <div class="col-md-12">
			<a href="#araK" class="btn btn-outline-secondary" data-bs-toggle="collapse"><%=p.jspTitle%> Ara</a>
					...
					<div class="row"> 
						<div class="col-md-auto col-4">
							...
							<input type="<%=p.inputTypes[0]%>" class="form-control form-control-sm" id="s_1" name="<%=p.selectFields[0]%>" 
									placeholder="<%=p.labelNames[0]%> giriniz.">
						</div>
						<div class="col-md-auto col-4">
						...
						<div class="col-md-auto col-4">
							<label for="s_3" style="margin-top: 7px;"><%=p.labelNames[2]%>:</label>
							<input type="<%=p.inputTypes[2]%>" class="form-control form-control-sm" id="s_3" name="<%=p.selectFields[2]%>"
									placeholder="<%=p.labelNames[2]%> giriniz.">
								&nbsp;&nbsp;&nbsp;
						</div>
					</div>
					<div class="row">&nbsp;</div>
	...
	<div id="alerts">
		...
		%>
		<%
			if (errorString != null && errorString.length() > 0 && menuString != null && leftSideStr != null) {
				if (p.isDebug) {
		%>
