...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		...
		<ul class="navbar-nav">
	      <li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="/JBCA_F/#">Pages</a>
		  ...
		  <li class='nav-item dropdown'>
			<a class='nav-link dropdown-toggle' data-toggle='dropdown' href='/JBCA_F/#'>Codes</a>
			  <div class='dropdown-menu'>
		  ...
		  <li class="nav-item">
			<a class="nav-link" href="/JBCA_F/menu/menu.jsp">Menus</a>
		  </li>
		  <li class="nav-item">
			<a class="nav-link" href="/JBCA_F/file/file.jsp">Files</a>
		  </li>
		  <li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="/JBCA_F/#">References</a>
			  <div class="dropdown-menu">
		  ...
		  <li class='nav-item dropdown'>
			<a class='nav-link dropdown-toggle' data-toggle='dropdown' href='/JBCA_F/#'>Info</a>
			  <div class='dropdown-menu'>
          		<a class='dropdown-item' href='/JBCA_F/info/contact.jsp'>Contact</a>
          	  </div>
		  </li>
		  <li class='nav-item dropdown'>
		    <a class='nav-link dropdown-toggle' data-toggle='dropdown' href='/JBCA_F/#'>Log Records</a>
		      <div class='dropdown-menu'>
	      ...
	      <li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="/JBCA_F/#">User</a>
			  <div class="dropdown-menu">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="<%=p.inputTypes[4]%>" class="form-control form-control-sm" name="<%=p.fieldNames[4]%>" id="y_4"
								placeholder="Enter <%=p.labelNames[4]%> giriniz." list="groups" required></td>
							...
							<td><input type="<%=p.inputTypes[6]%>" class="form-control form-control-sm" name="<%=p.fieldNames[6]%>" id="y_6"
								placeholder="Enter <%=p.labelNames[6]%> giriniz." list="statuses"></td>
						...
						<tr>
							...
							<td><input type="<%=p.inputTypes[7]%>" class="form-control form-control-sm" name="<%=p.fieldNames[7]%>" id="y_7"
								placeholder="Enter <%=p.labelNames[7]%> giriniz." min="10" max="100"></td>
							<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
							<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
						</tr>
						<tr>
	...
	<div class="row"> 
      <div class="col-md-12">
		<a href="#searchR" class="btn btn-outline-dark" data-toggle="collapse"><%=p.jspTitle%> Search</a>
					...
					<tbody>
						<tr>
							...
							<td><input type="<%=p.selectITs[1]%>" class="form-control form-control-sm" id="s_2" name="<%=p.selectFields[1]%>"
									   placeholder="Enter <%=p.selectLabels[1]%> giriniz."></td>
							...
							<td><input type="<%=p.selectITs[2]%>" class="form-control form-control-sm" id="s_3" name="<%=p.selectFields[2]%>" 
									   placeholder="Enter <%=p.selectLabels[2]%> giriniz." list="groups"></td>
						...
						<tr>
							...
							<td><input type="<%=p.selectITs[4]%>" class="form-control form-control-sm" id="s_5" name="<%=p.selectFields[4]%>" 
									   placeholder="Enter <%=p.selectLabels[4]%> giriniz." list="codes"></td>
