...
<%@ page session="false"%>
<%@ page import="com.jbca.page.PageParams,com.jbca.base.BaseProcesses, 
...
<%
	...
	String jsObjData = null, servletName = "pageServlet", selectLists = null,
	...
	try {
		...
		leftSideStr = p.pageBean.getPage(null, false, new String[] {"Pages-Sidebar","/JBCA_F/page/"});
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-11 col-xl-10">
				<a href="#newR" class="btn btn-outline-dark" data-toggle="collapse">New <%=p.jspTitle%></a>
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="<%=p.inputTypes[4]%>" class="form-control form-control-sm"
										name="<%=p.fieldNames[4]%>" id="y_4" placeholder="Enter <%=p.labelNames[4]%>" list="statuses"
										required></td>
									<datalist id="statuses"></datalist>
									<td>&nbsp;</td>
									<td><label for="y_5">Page :</label></td>
									<td><input type="file" class="form-control-file border form-control-sm"
										name="<%=p.fileField%>" id="y_5" required  onchange="fileInfo('y_5', 'y_1')"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#searchR" class="btn btn-outline-dark"
					data-toggle="collapse">Search <%=p.jspTitle%></a>
				<form method="post" id="searchR" class="form collapse"
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[2]%>"
										...
										placeholder="Enter <%=p.selectLabels[2]%>" list="paths"></td>
									...
									<td><input type="<%=p.selectITs[3]%>"
										...
										placeholder="Enter <%=p.selectLabels[3]%>" list="types"></td>
								</tr>
								<tr>
									...
									<td><input type="<%=p.selectITs[4]%>"
										...
										placeholder="Enter <%=p.selectLabels[4]%>" list="codes"></td>
									...
									<td><input type="<%=p.selectITs[6]%>"
										class="form-control form-control-sm" id="s_7"
										name="<%=p.selectFields[6]%>"
										placeholder="Enter <%=p.selectLabels[6]%>"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
								<tr>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_2", name:"adr_path"},{id:"y_3", name:"page_type"},{id:"y_4", name:"rec_status"}], 
						searchR:[{id:"s_3", name:"adr_path"}, {id:"s_4", name:"page_type"}, {id:"s_5", name:"rec_user"}], 
						updateR:[{id:"g_3", name:"adr_path"}, {id:"g_4", name:"page_type"},{id:"g_5", name:"rec_status"}]};
		
		listN4Page = [{id:"paths", name:"adr_path"}, {id:"types", name:"page_type"}, {id:"statuses", name:"rec_status"}, 
						{id:"codes", name:"rec_user"}];
		listN4Modal = [{id:"paths", name:"adr_path"}, {id:"types", name:"page_type"}, {id:"statuses", name:"rec_status"}];
					...
					<div class="form-group">
						...
						<div class="modal-footer">
							<table class="table table-borderless">
								<tbody id="modBt">
									<tr>
										<td><label for="g_8">Page :</label></td>
										<td><input type="file"
											class="form-control-file border form-control-sm"
											name="<%=p.fileField%>" id="g_8"></td>
									</tr>
									<tr>
										<td colspan="2">
											...
											<button type="button" class="btn btn-outline-info btn-sm"
												onclick='sendDownload("/<%=p.contextRoot%>/<%=servletName%>","updateR","g_2",true)'>
