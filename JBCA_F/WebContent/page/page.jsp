					...
					<div class="row"> 
						...
						<div class="col-md-auto col-4">
							...
							<input type="<%=p.inputTypes[3]%>" class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="y_3"
									placeholder="<%=p.labelNames[3]%> giriniz." list="types" required>
								<dataRegister id="types"></dataRegister>
						</div>
					</div>
					<div class="row">&nbsp;</div>
					<div class="row">
						<div class="col-md-auto col-4">
							...
							<input type="<%=p.inputTypes[4]%>" class="form-control form-control-sm" name="<%=p.fieldNames[4]%>" id="y_4"
									placeholder="<%=p.labelNames[4]%> giriniz." list="statuses" required>
								<dataRegister id="statuses"></dataRegister>
						</div>
						<div class="col-md-auto col-4">
							<label for="y_5">Sayfa :</label>
							<input type="file" class="form-control-file border form-control-sm" name="<%=p.fileField%>" id="y_5"
									required onchange="fileNameInfo('y_5', 'y_1')">
						</div>
					</div>
					<div class="row">&nbsp;</div>
					<div class="row">
