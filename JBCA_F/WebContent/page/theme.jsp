...
<body>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[2]%>"
										...
										placeholder="Enter <%=p.labelNames[2]%>." list="paths"
										required></td>
									...
									<td><input type="<%=p.inputTypes[3]%>"
										...
										placeholder="Enter <%=p.labelNames[3]%>." list="menus"
										required></td>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_2", name:"adr_path"}, {id:"y_3", name:"theme_menu"}], searchR:[{id:"s_3", name:"adr_path"},
					 	{id:"s_4", name:"rec_user"}], updateR:[{id:"g_3", name:"adr_path"}, {id:"g_4", name:"theme_menu"}]};
