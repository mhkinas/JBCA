...
<body>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_1", name:"mapped_page"}, {id:"y_2", name:"theme"}, {id:"y_3", name:"position"}], 
							araK:[{id:"s_2", name:"mapped_page"}, {id:"s_3", name:"theme"}, {id:"s_4", name:"rec_user"}], 
							guncelleK:[{id:"g_2", name:"mapped_page"}, {id:"g_3", name:"theme"},  {id:"g_4", name:"position"}]};
