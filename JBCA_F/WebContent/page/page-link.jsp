					...
					<div class="row"> 
						...
						<div class="col-md-auto col-4">
							...
							<input type="<%=p.inputTypes[3]%>" class="form-control form-control-sm" name="<%=p.fieldNames[3]%>" id="y_3"
									placeholder="<%=p.labelNames[3]%> giriniz." list="pages" required>
					...
					<div class="row">
						<div class="col-md-auto col-4">
							...
							<input type="<%=p.inputTypes[4]%>" class="form-control form-control-sm" name="<%=p.fieldNames[4]%>" id="y_4"
									placeholder="<%=p.labelNames[4]%> giriniz."  list="positions" required>
									<dataRegister id="positions"></dataRegister>
						</div>
						<div class="col-md-auto col-4">
							...
							<input type="<%=p.inputTypes[5]%>" class="form-control form-control-sm" name="<%=p.fieldNames[5]%>" id="y_5"
									placeholder="<%=p.labelNames[5]%> giriniz." list="themes" required>
									<dataRegister id="themes"></dataRegister>
						</div>
					</div>
					<div class="row">&nbsp;</div>
					<div class="row">
					...
					<div class="row"> 
						...
						<div class="col-md-auto col-3">
							...
							<input type="<%=p.selectITs[3]%>" class="form-control form-control-sm" id="s_4" name="<%=p.selectFields[3]%>"
									placeholder="<%=p.selectLabels[3]%> giriniz." list="pages">
						</div>
					</div>
					<div class="row">&nbsp;</div>
					<div class="row">
