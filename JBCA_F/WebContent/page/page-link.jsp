...
<%@ page session="false"%>
<%@ page import="com.jbca.page.PageLinkParams,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>
<%
	PageLinkParams p = new PageLinkParams();
	p.setLangEN();
	...
	String jsObjData = null, servletName = "pageLinkServlet", selectLists = null,
...
<body>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[3]%>"
										...
										placeholder="Enter <%=p.labelNames[3]%>" list="pages" required></td>
								...
								<tr>
									...
									<td><input type="<%=p.inputTypes[4]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[4]%>" id="y_4"
										placeholder="Enter <%=p.labelNames[4]%>" list="positions"
										required></td>
									...
									<td><input type="<%=p.inputTypes[5]%>"
										class="form-control form-control-sm"
										name="<%=p.fieldNames[5]%>" id="y_5"
										placeholder="Enter <%=p.labelNames[5]%>" list="themes"
										required></td>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[3]%>"
										...
										placeholder="Enter <%=p.selectLabels[3]%>" list="pages"></td>
								</tr>
								<tr>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_2", name:"adr_path"}, {id:"y_3", name:"linked_page"}, {id:"y_4", name:"position"}, 
							{id:"y_5", name:"theme"}], searchR:[{id:"s_3", name:"adr_path"}, {id:"s_4", name:"linked_page"},
							{id:"s_5", name:"rec_user"}], updateR:[{id:"g_3", name:"adr_path"}, {id:"g_4", name:"linked_page"}, 
							{id:"g_5", name:"position"}, {id:"g_6", name:"theme"}]};
		
		listN4Page = [{id:"paths", name:"adr_path"}, {id:"pages", name:"linked_page"}, {id:"positions", name:"position"}, 
					  {id:"themes", name:"theme"}, {id:"codes", name:"rec_user"}];

		listN4Modal = [{id:"paths", name:"adr_path"}, {id:"pages", name:"linked_page"}, {id:"positions", name:"position"}, 
