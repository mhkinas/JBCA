...
<%@ page session="false"%>
<%@ page import="com.jbca.page.PageMapParams,com.jbca.base.BaseProcesses, 
				 com.sdb.utility.JsonConverter, 
				 com.sdb.utility.ArrayToString, 
				 java.util.Arrays"%>
<%
	PageMapParams p = new PageMapParams();
	p.setLangEN();
	...
	String jsObjData = null, servletName = "pageMapServlet", selectLists = null,
...
<body>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[1]%>"
										...
										placeholder="<%=p.labelNames[1]%> giriniz." list="pages"
										required></td>
									...
									<td><input type="<%=p.inputTypes[2]%>"
										...
										placeholder="<%=p.labelNames[2]%> giriniz." list="themes"
										required></td>
									...
									<td><input type="<%=p.inputTypes[3]%>"
										...
										placeholder="<%=p.labelNames[3]%> giriniz." list="positions"
										required></td>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[1]%>"
										...
										placeholder="<%=p.selectLabels[1]%> giriniz." list="pages"></td>
									...
									<td><input type="<%=p.selectITs[2]%>"
										...
										placeholder="<%=p.selectLabels[2]%> giriniz." list="themes"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
								<tr>
	...
	<%}%>		
		...
		selInpIds = {newR:[{id:"y_1", name:"mapped_page"}, {id:"y_2", name:"theme"}, {id:"y_3", name:"position"}], 
							searchR:[{id:"s_2", name:"mapped_page"}, {id:"s_3", name:"theme"}, {id:"s_4", name:"rec_user"}], 
							updateR:[{id:"g_2", name:"mapped_page"}, {id:"g_3", name:"theme"},  {id:"g_4", name:"position"}]};
		
		listN4Page = [{id:"pages", name:"mapped_page"}, {id:"themes", name:"theme"}, {id:"positions", name:"position"}, 
					  {id:"codes", name:"rec_user"}];

		listN4Modal = [{id:"pages", name:"mapped_page"}, {id:"themes", name:"theme"}, {id:"positions", name:"position"}];
