...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-11 col-xl-10">
				<a href="#yeniK" class="btn btn-outline-dark" data-toggle="collapse">Yeni
					<%=p.jspTitle%></a>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.inputTypes[3]%>"
										...
										placeholder="<%=p.labelNames[3]%> giriniz." list="pages"
										required></td>
								...
								<tr>
									...
									<td><input type="<%=p.inputTypes[4]%>"
										...
										placeholder="<%=p.labelNames[4]%> giriniz." list="positions"
										required></td>
									...
									<td><input type="<%=p.inputTypes[5]%>"
										...
										placeholder="<%=p.labelNames[5]%> giriniz." list="themes"
										required></td>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[3]%>"
										...
										placeholder="<%=p.selectLabels[3]%> giriniz." list="pages"></td>
								</tr>
								<tr>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_2", name:"adr_path"}, {id:"y_3", name:"linked_page"}, {id:"y_4", name:"position"}, 
							{id:"y_5", name:"theme"}], araK:[{id:"s_3", name:"adr_path"}, {id:"s_4", name:"linked_page"},
							{id:"s_5", name:"rec_user"}], guncelleK:[{id:"g_3", name:"adr_path"}, {id:"g_4", name:"linked_page"}, 
