...
<body>
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="<%=p.inputTypes[4]%>"
										...
										placeholder="<%=p.labelNames[4]%> giriniz." list="statuses"
										required></td>
									<datalist id="statuses"></datalist>
									<td>&nbsp;</td>
									<td><label for="y_5">Dosya :</label></td>
									<td><input type="file"
										class="form-control-file border form-control-sm"
										name="<%=p.fileField%>" id="y_5" required 
										onchange="fileNameInfo('y_5', 'y_1')"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td><input type="<%=p.selectITs[3]%>"
										...
										placeholder="<%=p.selectLabels[3]%> giriniz." list="types"></td>
								</tr>
								<tr>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_2", name:"adr_path"},{id:"y_3", name:"page_type"},{id:"y_4", name:"rec_status"}], 
						araK:[{id:"s_3", name:"adr_path"}, {id:"s_4", name:"page_type"}, {id:"s_5", name:"rec_user"}], 
						guncelleK:[{id:"g_3", name:"adr_path"}, {id:"g_4", name:"page_type"},{id:"g_5", name:"rec_status"}]};
					...
					<div class="form-group">
						...
						<div class="modal-footer">
							<table class="table table-borderless">
								<tbody id="modBt">
									<tr>
										<td><label for="g_8">Dosya :</label></td>
										<td><input type="file"
											class="form-control-file border form-control-sm"
									...
									<tr>
										<td colspan="2">
											...
											<button type="button" class="btn btn-outline-info btn-sm"
												onclick='sendDownload("/<%=p.contextRoot%>/<%=servletName%>","guncelleK","g_2",true)'>
												Dosya İndir</button> &nbsp;
