...
<%@ page session="false"%>
<%@ page import="com.jbca.exchange.ExcRateParams,com.jbca.base.BaseProcesses, 
...
<%
	...
	String jsObjData = null, servletName = "excRateServlet", selectLists = null, errorString = null, qsql = null, 
			menuString = null, leftSideStr = null, excelCols = null, numStep = "0.0001";
...
<body>
				...
				<div class="row"> 
					<div class="col-md-auto col-4">
						...
						<input type="<%=p.inputTypes[1]%>" class="form-control form-control-sm" name="<%=p.fieldNames[1]%>" id="y_1"
							placeholder="<%=p.labelNames[1]%> giriniz." list="currency" required>
						<dataRegister id="currency"></dataRegister>
					</div>
					<div class="col-md-auto col-4">
				...
				<div class="row">
					<div class="col-md-auto col-4">
						...
						<input type="<%=p.inputTypes[4]%>" class="form-control form-control-sm" name="<%=p.fieldNames[4]%>" id="y_4"
							placeholder="<%=p.labelNames[4]%> giriniz." required>
					</div>
					<div class="col-md-auto col-4">
					...
					<div class="col-md-auto col-4">
						...
						<input type="<%=p.inputTypes[6]%>" class="form-control form-control-sm" name="<%=p.fieldNames[6]%>" id="y_6"
							placeholder="<%=p.labelNames[6]%> giriniz." required>
				</div>
				<div class="row">&nbsp;</div>
				<div class="row">
					<div class="col-md-auto col-2">
						<button type="submit" class="btn btn-outline-info btn-sm"
								onclick='sendFormWF("/<%=p.contextRoot%>/<%=servletName%>","yeniK","insert")'>Kaydet</button>
					</div>
					<div class="col-md-auto col-2">
	...
	<div class="row"> 
      <div class="col-sm-11 col-md-10">
			<button type="button" class="btn btn-outline-dark"
					onclick='sendFormWF("/<%=p.contextRoot%>/<%=servletName%>","noID","currency")'><%=p.jspTitle%> Al</button>
	  </div>
	</div>
				...
				<div class="row"> 
					<div class="col-md-auto col-4">
							...
							<input type="<%=p.selectITs[0]%>" class="form-control form-control-sm" id="s_1" name="<%=p.selectFields[0]%>" 
									   placeholder="<%=p.selectLabels[0]%> giriniz." list="currency">
					</div>
				</div>
				<div class="row">&nbsp;</div>
				<div class="row">
					<div class="col-md-auto col-2">
						<button type="button" class="btn btn-outline-info btn-sm"
								onclick='sendFormWF("/<%=p.contextRoot%>/<%=servletName%>","araK","select")'>Ara</button>
					</div>
					<div class="col-md-auto col-2">
						<button type="reset" class="btn btn-outline-secondary btn-sm">İptal</button>
					</div>
			...
			<table class="table table-striped table-bordered table-condensed table-sm">
				<thead>
					...
					<tr>
						...
						<th onclick="sortByDate('<%=p.fieldNames[8]%>', true)"><%=p.labelNames[8]%></th>
					</tr>
				</thead>
				<tbody id="listTb">
				</tbody>
  ...
  <script>
	...
	<%}%>		
		...
		selInpIds = {yeniK:[{id:"y_1", name:"cur_code"}], araK:[{id:"s_2", 
			name:"cur_code"}], guncelleK:[{id:"g_2", name:"cur_code"}]};

		listN4Page = {id:"currency", name:"cur_code"};
		listN4Modal = {id:"currency", name:"cur_code"};
