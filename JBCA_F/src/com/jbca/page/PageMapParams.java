...
public class PageMapParams extends BaseParameters 
{
	public void initParams()
	{
		...
		isDebug = true;
		tableNames = new String[] {"jbc_page_map","vt_jbc_page_map"};
		...
		dataType = STRING;
		orderBy = "id";
		refTableNames = new String[] {"jbc_page","jbc_theme","jbc_position","jbc_user"};
