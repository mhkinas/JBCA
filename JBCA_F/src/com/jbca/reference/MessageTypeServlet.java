...
@WebServlet(urlPatterns = "/messageTypeServlet", 
			loadOnStartup = 1,
			asyncSupported = true)
@MultipartConfig (fileSizeThreshold = 1024*1024, 
					maxFileSize = 1024*1024*5, 
					maxRequestSize = 1024*1024*5*5) // location = StaticParams.mPLocation,
public class MessageTypeServlet extends HttpServlet
{
	private static final long serialVersionUID = -1909607976302593597L;

	private MessageTypeParams p;
