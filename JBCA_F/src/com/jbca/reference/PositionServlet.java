...
@WebServlet(urlPatterns = "/positionServlet", 
			loadOnStartup = 1,
			asyncSupported = true)
...
{
	private static final long serialVersionUID = -207572149467084359L;

	private PositionParams p;
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        p.action = request.getParameter("action").toString();
