...
@WebServlet(urlPatterns = "/genelParamServlet", 
loadOnStartup = 1,
asyncSupported = true)
@MultipartConfig (fileSizeThreshold = 1024*1024, 
		maxFileSize = 1024*1024*5, 
		maxRequestSize = 1024*1024*5*5) // location = StaticParams.mPLocation,
public class GeneralParamServlet extends HttpServlet {

	private static final long serialVersionUID = 6180887197499656199L;
