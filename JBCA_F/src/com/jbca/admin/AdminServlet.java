	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	try {
    		...
    		if(p.action.equals("select")) { // Record search from db
	    		...
	    		if(p.formData[6].isBlank()) 
	    			p.formData[6] = "Active";
	    		
	    		int pageSize = 0;
	    		if(!p.formData[7].isBlank()) {
	    			
	    			System.out.println("p.formData[7] :" + p.formData[7]);
	    			pageSize = Integer.parseInt(p.formData[7]);
	    		}
	    		if(p.formData[7] == null || pageSize <= 0)
	    			p.formData[7] = "100";
