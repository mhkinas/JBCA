...
--
-- Table structure for table `jbc_log_type`
--

DROP TABLE IF EXISTS `jbc_log_type`;
...
--
-- Dumping data for table `jbc_log_type`
--

LOCK TABLES `jbc_log_type` WRITE;
/*!40000 ALTER TABLE `jbc_log_type` DISABLE KEYS */;
INSERT INTO `jbc_log_type` VALUES (3,'delete'),(1,'insert'),(2,'update');
