...
--
-- Table structure for table `jbc_code_type`
--

DROP TABLE IF EXISTS `jbc_code_type`;
...
--
-- Dumping data for table `jbc_code_type`
--

LOCK TABLES `jbc_code_type` WRITE;
/*!40000 ALTER TABLE `jbc_code_type` DISABLE KEYS */;
INSERT INTO `jbc_code_type` VALUES (2,'css'),(6,'dnm06'),(8,'dnm08'),(7,'HTML'),(1,'javascript'),(3,'other'),(4,'XML');
