...
--
-- Table structure for table `jbc_message_type`
--

DROP TABLE IF EXISTS `jbc_message_type`;
...
--
-- Dumping data for table `jbc_message_type`
--

LOCK TABLES `jbc_message_type` WRITE;
/*!40000 ALTER TABLE `jbc_message_type` DISABLE KEYS */;
INSERT INTO `jbc_message_type` VALUES (2,'alert'),(4,'error'),(1,'info'),(3,'warning');
