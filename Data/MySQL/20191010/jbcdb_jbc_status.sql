...
--
-- Table structure for table `jbc_status`
--

DROP TABLE IF EXISTS `jbc_status`;
...
--
-- Dumping data for table `jbc_status`
--

LOCK TABLES `jbc_status` WRITE;
/*!40000 ALTER TABLE `jbc_status` DISABLE KEYS */;
INSERT INTO `jbc_status` VALUES (1,'Active'),(2,'Passive');
